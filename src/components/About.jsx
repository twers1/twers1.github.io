...
const About = () => {
  return (
    <>
      ...
      >
        I'm a novice software developer in TypeScript, JavaScript, Java, C#, 
        and I also have experience with React, Node.js, Three.js, Nest.js, Next.js and many other frameworks.
